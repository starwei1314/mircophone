...
public class CharacterParser {
    ...
    public static int[] pyvalue = new int[]{-20319, -20317, -20304, -20295, -20292, -20283, -20265, -20257, -20242, -20230, -20051, -20036, -20032,
    ...
    public static String[] pystr = new String[]{"a", "ai", "an", "ang", "ao", "ba", "bai", "ban", "bang", "bao", "bei", "ben", "beng", "bi", "bian",
            ...
            "li", "lia", "lian", "liang", "liao", "lie", "lin", "ling", "liu", "long", "lou", "lu", "strLv", "luan", "lue", "lun", "luo", "ma", "mai",
    ...
    public String getSortLetters(String nickName){
        String pinyin = this.getSelling(nickName);
