...
public class NewFriendPreviewActivity extends BaseActivity{
    ...
    protected void initView() {
        ...
        final ArrayList<String> newFriendJsons = intent.getStringArrayListExtra("newFriendJsons");
        Log.e("====", "initView: " + "\n" +newFriendJsons);

        mSc_rl = ((RelativeLayout) findViewById(R.id.sc_rl));
        mScreenshotImg = ((ImageView) findViewById(R.id.screenshot_img));
        mWebView = ((WebView) findViewById(R.id.new_friend_preview_webView));

        mWebView.getSettings().setJavaScriptEnabled(true);
        mWebView.addJavascriptInterface(this,"app");
        mWebView.loadUrl("file:///android_asset/new_friend.html");
        mWebView.setWebViewClient(new WebViewClient(){
            @Override
            public void onPageFinished(WebView view, String url) {
                super.onPageFinished(view, url);
                String s = newFriendJsons.get(0);
                Log.e("newFriendJsons",s);
                mWebView.loadUrl("Javascript:initFriendList('"+newFriendJsons+"')");
            }
        });
        InitScreenshot();
    }
    ...
    public int getLayoutRes() {
        return R.layout.activity_new_friend_preview;
    }
