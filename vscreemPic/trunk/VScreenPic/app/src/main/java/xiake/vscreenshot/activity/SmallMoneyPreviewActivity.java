 ...
 */
public class SmallMoneyPreviewActivity extends BaseActivity{
    private static final String TAG = "SmallMoneyActivity";
    ...
    protected void initView() {
        ...
        mWebView = ((WebView) findViewById(R.id.smallmoney_preview_webView));
        mWebView.getSettings().setJavaScriptEnabled(true);
        mWebView.addJavascriptInterface(this,"app");
        mWebView.loadUrl("file:///android_asset/my_money.html");
    ...
    public int getLayoutRes() {
        return R.layout.activity_smallmoney_preview;
    }
