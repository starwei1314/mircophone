...
import xiake.vscreenshot.img.ImageDirectoryModel;
...
public class PickOrTakeImageActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener,
    ...
    private class GridViewAdapter extends BaseAdapter{
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (bitmap != null){
                ...
                holder.iv_content.setBackgroundResource(R.drawable.shape_album_bg);
            }
            return view;
        }
    }
    ...
    private class ListviewAdapter extends BaseAdapter{
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (bitmap != null){
                ...
                holder.iv_directory_pic.setBackgroundResource(R.drawable.shape_album_bg);
            }
            return view;
        }
    }
    ...
    private void returnDataAndClose(){
        ...
        data.putExtra("data", textview.getText());
